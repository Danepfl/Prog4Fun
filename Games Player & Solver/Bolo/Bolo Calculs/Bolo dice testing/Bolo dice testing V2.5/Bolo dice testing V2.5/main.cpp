...
int a2, a3, a5, a6, a8, a9, b2, b3, b5, b6, counttour, jk;
string premier, a1, a4, a7, b1, b4, okk, hasard, meiljo;
long double deltatj, deltaptt, ord1, x7, x6, x5, x4, x3, x2, x1, ptstour, pt7, pt6, pt5, pt4, pt3, pt2, pt1, fracdone;
...
int main() {
    ...
    /*for(x7=1460; x7<=1540; x7=x7+40){//x1-x7 pour alpha1-alpha7
     for(x6=180; x6<=200; x6=x6+10){
     for(x5=100; x5<=120; x5=x5+10){
     for(x4=100; x4<=120; x4=x4+10){
     for(x3=170; x3<=190; x3=x3+10){
     for(x2=300; x2<=320; x2=x2+10){*/
    x7=1480; x6=190; x5=120; x4=120; x3=170; x2=320;//793, 794, 793
    x1=518.33333;//794, 792, 793
    ...
    if(bestp < ptstour){
        ...
        pt7=x7; pt6=x6;pt5=x5;pt4=x4;pt3=x3;pt2=x2;pt1=x1;
    }
    ord1=0;
    
    /*fracdone++;
     cout<< "Done:" << fracdone/7.29 << "%" << endl;
     }}}}}}//fin des boucles for des differentes variables des points moyens
     */
    
    cout << endl << endl << "Pts moyens 7 " << pt7 << endl << "Pts moyens 6 " << pt6 << endl  << "Pts moyens 5 " << pt5 << endl << "Pts moyens 4 " << pt4 << endl << "Pts moyens 3 " << pt3 << endl << "Pts moyens 2 " << pt2 << endl << "Pts moyens 1 " << pt1 << endl << "Points moyens tour: " << bestp << endl << endl;
}//fin du main
