...
int main(){
    ...
    double cbp(0), cbg(0), cbg1(0), cbg2(0), cbg3(0), cbg4(0), cbg5(0), cbg6(0), cbg0(0), spttot(0), spt1(0), spt2(0), spt3(0), spt4(0), spt5(0), spt6(0), spt0(0), cbg_1(0), cbg_2(0), cbg_3(0), cbg_4(0), cbg_5(0), cbg_6(0), cbg_0(0);
    double ptm6(0), ptm5(0), ptm4(0), ptm3(0), ptm2(0), ptm1(0), ptm0(0), pb6(0), pb5(0), pb4(0), pb3(0), pb2(0), pb1(0), pb0(0);
                        ...
                        for(int i6=1; i6<7; i6++){
                            for(int i7=1; i7<7; i7++){
                                ...
                                if ((desopt.size() == 0) && (ptopt.size() == 0)) {
                                    ...
                                    a9 = sptopt.size();
                                    double a8 = 0;
                                    a8 = (cbg0+cbg1+cbg2+cbg3+cbg4+cbg5+cbg6);
                                    ...
                                    for (int i=0; i<a9; i++){spttot=spttot+(sptopt[i]/a9);
                                        switch(sdesopt[i]){
                                            case 1:
                                                spt6 = spt6 + (sptopt[i]);
                                                cbg6 = cbg6 + (1/a9);
    ...
    if ((cbg+cbp)!=279936){cerr << "Erreur de cbg cbp"<<endl;}
    ...
    cout << "combgagn = " << cbg << endl << "combperd = " << cbp << endl << "sommepttot = " << spttot << endl << "ptsmoy6 = " << ptm6 << " prob6 = " << pb6 << endl << "ptsmoy5 = " << ptm5 << " prob5 = " << pb5 << endl << "ptsmoy4 = " << ptm4 << " prob4 = " << pb4 << endl << "ptsmoy3 = " << ptm3 << " prob3 = " << pb3 << endl << "ptsmoy2 = " << ptm2 << " prob2 = " << pb2 << endl << "ptsmoy1 = " << ptm1 << " prob1 = " << pb1 << endl << "ptsmoy0 = " << ptm0 << " prob0 = " << pb0 << endl;
    cout << cbg_6 << " " <<cbg_5 << " " << cbg_4 << " " << cbg_3 << " " << cbg_2 << " " << cbg_1 << " " << cbg_0 << endl;
