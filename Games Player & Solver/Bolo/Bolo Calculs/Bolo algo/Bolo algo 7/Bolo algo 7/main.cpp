...
int main(){
    ...
    double cbp(0), cbg(0), cbg1(0), cbg2(0), cbg3(0), cbg4(0), cbg5(0), cbg6(0), cbg0(0), ptmtot(0), spt1(0), spt2(0), spt3(0), spt4(0), spt5(0), spt6(0), spt0(0), cbg_1(0), cbg_2(0), cbg_3(0), cbg_4(0), cbg_5(0), cbg_6(0), cbg_0(0);
    ...
    ptm1 = (spt1/cbg_1);
    ptm0 = (spt0/cbg_0);
    ptmtot = (ptm6*pb6 + ptm5*pb5 + ptm4*pb4 + ptm3*pb3 + ptm2*pb2 + ptm1*pb1 + ptm0*pb0)*0.01;
    double pbp;
    pbp = (cbp/2799.36);
    cout << "combgagn = " << cbg << endl << "combperd = " << cbp << endl << "ptmoytot = " << ptmtot << endl << "ptsmoy6 = " << ptm6 << " prob6 = " << pb6 << endl << "ptsmoy5 = " << ptm5 << " prob5 = " << pb5 << endl << "ptsmoy4 = " << ptm4 << " prob4 = " << pb4 << endl << "ptsmoy3 = " << ptm3 << " prob3 = " << pb3 << endl << "ptsmoy2 = " << ptm2 << " prob2 = " << pb2 << endl << "ptsmoy1 = " << ptm1 << " prob1 = " << pb1 << endl << "ptsmoy0 = " << ptm0 << " prob0 = " << pb0 << endl << "probperte = " << pbp <<endl;
