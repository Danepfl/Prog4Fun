...
int main(){
    ...
    double cbp(0), cbg(0), cbg1(0), cbg2(0), cbg3(0), cbg0(0), ptmtot(0), spt1(0), spt2(0), spt3(0), spt0(0), cbg_1(0), cbg_2(0), cbg_3(0), cbg_0(0);
    double ptm3(0), ptm2(0), ptm1(0), ptm0(0), pb3(0), pb2(0), pb1(0), pb0(0);
    ...
    }//fermeture dernier for(i4)
    //if((cbg0+cbg1+cbg2+cbg3+cbg4+cbg5+cbg6)!=cbg){cerr << "erreur addition" << endl;}
    if ((cbg+cbp)!=1296){cerr << "Erreur de cbg cbp"<<endl;}
    ...
    ptm1 = (spt1/cbg_1);
    ptm0 = (spt0/cbg_0);
    ptmtot =  (ptm3*pb3 + ptm2*pb2 + ptm1*pb1 + ptm0*pb0)*0.01;
    double pbp;
    pbp = (cbp/12.96);
    cout << "combgagn = " << cbg << endl << "combperd = " << cbp << endl << "ptmoytot = " << ptmtot << endl << "ptsmoy3 = " << ptm3 << " prob3 = " << pb3 << endl << "ptsmoy2 = " << ptm2 << " prob2 = " << pb2 << endl << "ptsmoy1 = " << ptm1 << " prob1 = " << pb1 << endl << "ptsmoy0 = " << ptm0 << " prob0 = " << pb0 << endl << "probperte = " << pbp <<endl;
