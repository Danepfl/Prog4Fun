...
int main(){
    ...
    double cbp(0), cbg(0), cbg0(0), ptmtot(0), spt0(0), cbg_0(0);
    double ptm0(0), pb0(0);
    ...
    if ((cbg+cbp)!=6){cerr << "Erreur de cbg cbp"<<endl;}
    //if (spttot!=(spt0+spt1+spt2+spt3+spt4+spt5+spt6)){cerr << "erreur somme points" << endl;}
    
    pb0 = (cbg0/0.06);
    ptm0 = (spt0/cbg_0);
    ptmtot =  (ptm0*pb0)*0.01;
    double pbp;
    pbp = (cbp/0.06);
    cout << "combgagn = " << cbg << endl << "combperd = " << cbp << endl << "ptmoytot = " << ptmtot << endl << "ptsmoy0 = " << ptm0 << " prob0 = " << pb0 << endl << "probperte = " << pbp <<endl;
