...
int main(){
    ...
    double cbp(0), cbg(0), cbg1(0), cbg0(0), ptmtot(0), spt1(0), spt0(0), cbg_1(0), cbg_0(0);
    double ptm1(0), ptm0(0), pb1(0), pb0(0);
    ...
    ptm1 = (spt1/cbg_1);
    ptm0 = (spt0/cbg_0);
    ptmtot =  (ptm1*pb1 + ptm0*pb0)*0.01;
    double pbp;
    pbp = (cbp/0.36);
    cout << "combgagn = " << cbg << endl << "combperd = " << cbp << endl << "ptmoytot = " << ptmtot << endl << "ptsmoy1 = " << ptm1 << " prob1 = " << pb1 << endl << "ptsmoy0 = " << ptm0 << " prob0 = " << pb0 << endl << "probperte = " << pbp <<endl;
