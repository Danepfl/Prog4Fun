...
int main(){
    ...
    double cbp(0), cbg(0), cbg1(0), cbg2(0), cbg0(0), ptmtot(0), spt1(0), spt2(0), spt0(0), cbg_1(0), cbg_2(0), cbg_0(0);
    double ptm2(0), ptm1(0), ptm0(0), pb2(0), pb1(0), pb0(0);
    ...
    if ((cbg+cbp)!=216){cerr << "Erreur de cbg cbp"<<endl;}
    ...
    ptm1 = (spt1/cbg_1);
    ptm0 = (spt0/cbg_0);
    ptmtot =  (ptm2*pb2 + ptm1*pb1 + ptm0*pb0)*0.01;
    double pbp;
    pbp = (cbp/2.16);
    cout << "combgagn = " << cbg << endl << "combperd = " << cbp << endl << "ptmoytot = " << ptmtot << endl << "ptsmoy2 = " << ptm2 << " prob2 = " << pb2 << endl << "ptsmoy1 = " << ptm1 << " prob1 = " << pb1 << endl << "ptsmoy0 = " << ptm0 << " prob0 = " << pb0 << endl << "probperte = " << pbp <<endl;
